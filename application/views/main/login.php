...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Absensi Untad">
    <meta name="keywords" content="Absensi Untad">
    <meta name="author" content="kreasiber">
    <link rel="icon" href="<?= base_url('assets/images/favicon.png'); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url('assets/images/favicon.png'); ?>" type="image/x-icon">
    <title>Absensi Untad</title>
    <!-- Google font-->
        ...
        <div class="row">
          ...
          <div class="col-xl-5 p-0">
            <div class="login-card">
              <form class="theme-form login-form" method="post" action="<?= base_url('auth/proc_login') ?>">
                <?php
                  if (isset($error)) {
                ?>
                ...
                ?>
                <h4>Login</h4>
                <h6>Website Absensi Untad.</h6>
                <div class="form-group">
                  <label>Email</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                    <input class="form-control" type="text" required="" name="username" placeholder="enter email">
                  </div>
                </div>
                <div class="form-group">
