		...
		<div class="col">
			...
			<div class="card h-md-100">
				...
				<div class="card-header align-items-center border-0">
					<!--begin::Title-->
					<h3 class="fw-bold text-gray-900 m-0">Add Modul</h3>
					<!--end::Title-->
				</div>
				<!--end::Header-->
				<!--begin::Body-->
				<div class="card-body pt-2">
					...
					?>
					<form action="<?= base_url('data_modul/post') ?>" method="post">
						<div class="row">
							<div class="col-md-6 mb-10">
								<label class="form-label required">Judul Modul</label>
								<input type="text" class="form-control" name="judul_modul" placeholder="Masukkan Judul Modul"/>
							</div>
							<div class="col-md-6 mb-10">
								<label class="form-label required">Link Berkas</label>
								<input type="text" class="form-control" name="link_berkas" placeholder="Masukkan Link Berkas"/>
							</div>
						</div>
						<div class="row">
